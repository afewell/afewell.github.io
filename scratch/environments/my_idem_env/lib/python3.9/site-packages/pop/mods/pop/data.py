...
class NullMap(IMAP):
    """
    Before the IMAP structure has been initialized for hub.OPT, allow getitem to always succeed
    """
    ...
    def __iter__(self):
        raise ValueError("Uninitialized IMAP")


def null_map(hub: "pop.hub.Hub"):
    return NullMap()
